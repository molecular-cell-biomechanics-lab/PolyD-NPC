...
cd ${d_per}
tar -zxf cg_s${po_seed}.tar.gz cg_s${po_seed}_t${po_prev}_vtx.vtk
tar -zxf fg_s${po_seed}.tar.gz fg_s${po_seed}_t${po_prev}.vtk
mv cg_s${po_seed}_t${po_prev}_vtx.vtk 	${s_vtk}/
mv fg_s${po_seed}_t${po_prev}.vtk 		${s_vtk}/
...
cd ${s_out}
tar -zcf fg_s${po_seed}_1.tar.gz fg*
tar -zcf cg_s${po_seed}_1.tar.gz cg*
