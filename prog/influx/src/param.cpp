...
#ifdef DEBUG
	const static char path_input[] = "../influx/src/input/debug";	// path to the input directory	
#else
	const static char path_input[] = "../influx/src/input";		// path to the input directory
#endif
